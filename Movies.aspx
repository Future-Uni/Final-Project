            ...
            <table cellpadding="4" cellspacing="4" class="auto-style1">
                <tr>
                    <td class="auto-style32" colspan="3">
                        <asp:Label ID="Label1" runat="server" Font-Names="Stencil" Font-Size="XX-Large" ForeColor="#e0ac1b" Text="SEARCH FOR YOUR MOVIE:"></asp:Label>
                        <asp:TextBox ID="txtsearch" runat="server" BorderColor="#e0ac1b" BorderWidth="5px" CssClass="auto-style31" Height="44px" Width="575px"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnsearch" runat="server" BackColor="White" BorderColor="#e0ac1b" BorderStyle="Dotted" CssClass="auto-style34" Font-Names="Stencil" ForeColor="#e0ac1b" OnClick="btnsearch_Click" Text="SEARCH" Width="102px" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </td>
                </tr>
                <tr>
                    <td class="auto-style32" colspan="3">
                        <asp:Label ID="lblmsg" runat="server" Font-Names="Stencil" Font-Size="X-Large" ForeColor="#e0ac1b"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style32" colspan="3">
                ...
                <tr>
                    <td class="auto-style25">
                        ...
                        <asp:HyperLink ID="HyperLink1" runat="server" Font-Names="Stencil" Font-Size="X-Large" ForeColor="#E0AC1B" NavigateUrl="~/endgame.aspx" Target="F5">Endgame</asp:HyperLink>
                    </td>
                    <td class="auto-style26">
                        ...
                        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:HyperLink ID="HyperLink2" runat="server" Font-Names="Stencil" Font-Size="X-Large" ForeColor="#E0AC1B" NavigateUrl="~/joker.aspx" Target="F5">joker</asp:HyperLink>
                    </td>
                    <td class="auto-style27">
                        <img alt="" class="auto-style29" src="moviesposters/the%20revenant.jpg" /><br />
                        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:HyperLink ID="HyperLink3" runat="server" Font-Names="Stencil" Font-Size="X-Large" ForeColor="#E0AC1B" NavigateUrl="~/therevenant.aspx" Target="F5">the revenant</asp:HyperLink>
                        <br />
                    </td>
                </tr>
                <tr>
                    <td class="auto-style10">
                        ...
                        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:HyperLink ID="HyperLink4" runat="server" Font-Names="Stencil" Font-Size="X-Large" ForeColor="#E0AC1B" NavigateUrl="~/thegreenmile.aspx" Target="F5">THE GREEN MILE</asp:HyperLink>
                    </td>
